...
function App() {
  ...
  return (
    <div>
    <div className="bg-blue-100 w-screen h-100 m-0 flex justify-center items-center">
   ...
   <div className="container pt-11 ml-9">
     <div className="mb-11 flex justify-center">
       ...
       <a href="https://twitter.com/mvaibhav131" className="mr-11 text-neutral-800 dark:text-neutral-200">
         <svg
           xmlns="http://www.w3.org/2000/svg"
           className="h-4 w-4"
           fill="currentColor"
       ...
       <a href="https://vaibhav-more-portfolio-site.netlify.app/" className="mr-9 text-neutral-800 dark:text-neutral-200">
         <svg
           xmlns="http://www.w3.org/2000/svg"
           className="h-5 w-5"
           fill="currentColor"
       ...
       <a href="https://www.instagram.com/vaibhavmore1997/" className="mr-9 text-neutral-800 dark:text-neutral-200">
         <svg
           xmlns="http://www.w3.org/2000/svg"
           className="h-4 w-4"
           fill="currentColor"
       ...
       <a href="https://www.linkedin.com/in/vaibhav131/" className="mr-9 text-neutral-800 dark:text-neutral-200">
         <svg
           xmlns="http://www.w3.org/2000/svg"
           className="h-4 w-4"
           fill="currentColor"
       ...
       <a href="https://github.com/mvaibhav131" className="text-neutral-800 dark:text-neutral-200">
         <svg
           xmlns="http://www.w3.org/2000/svg"
           className="h-4 w-4"
           fill="currentColor"
